...
const AddtoRecords = () => {
  ...
  const isActive = (path: string) => location.pathname === path;
    ...
    const severityOptions: string[] = ["Mild", "Moderate", "Severe", "Critical"];
                    ...
                    <form className=''>
                        ...
                        <div className="medication-info-card border border-gray-300 mt-10 rounded-lg w-full">
                            ...
                            {medicalHistory.map((h, index) => (
                                ...
                                { id: "conditionType", label: "Condition Type", type: "select" },
                                ...
                                <div className="flex flex-col" key={field.id}>
                                    ...
                                    <select
                                        id={`${field.id}-${index}`}
                                        value={h[field.id as keyof typeof h] as string}
                                        onChange={(e) =>
                                        updateItem(
                                            setMedicalHistory,
                                            index,
                                    ...
                                    <select
                                        ...
                                        value={h[field.id as keyof typeof h] as string}
                                        onChange={(e) =>
                                        updateItem(setMedicalHistory, index, field.id, e.target.value, medicalHistory)
                                        }
                                        className="p-2 rounded border border-gray-400 outline-primary"
                                    >
                            ...
                            {allergies.map((a, index) => (
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-3">
                                    ...
                                    { id: "severity", label: "Severity", type: "select-severity" }, // dropdown
                                    ].map((field) => (
                                    <div className="flex flex-col" key={field.id}>
                                        <label
                                        htmlFor={`${field.id}-${index}`}
                                        ...
                                        <select
                                            id={`${field.id}-${index}`}
                                            value={a[field.id as keyof typeof a] as string}
                                            onChange={(e) =>
                            ...
                            {labResults.map((l, index) => (
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-3">
                                    ...
                                    { id: "testFlag", label: "Flag", type: "select", options: flagOptions }, // dropdown
                                    ].map((field) => (
                                    <div className="flex flex-col" key={field.id}>
                                        <label
                                        htmlFor={`${field.id}-${index}`}
