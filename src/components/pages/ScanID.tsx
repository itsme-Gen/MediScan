                        ...
                        <div className="title">
                            ...
                            {image ? (
                                <div className="image-preview flex justify-center items-center">
                                    <img src={image} alt="Image ID" className='rounded-lg max-h-80' />
                                </div>
                            ) : (
                            ...
                            <div className="button-container grid grid-cols-2 mt-5 gap-2">
                                ...
                                <label
                                    ...
                                    className='bg-primary flex flex-row text-white text-md rounded-sm p-2 items-center justify-center gap-2 cursor-pointer'
                                >
                                    <ImageUp className='h-5 w-5' /> Upload Image
                                </label>

                                <button
                                    className='border border-gray rounded-sm text-md text-black flex flex-row justify-center items-center gap-2'
                                >
